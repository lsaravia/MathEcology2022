...
# ╔═╡ e7645c38-10ab-4bd8-8670-9c6251e84da6
using Plots

# ╔═╡ 25e70f0a-a09b-11ec-3213-c30fb6e8a56b
md"## Epidemiología modelo SIS Estocástico
...
* Podemos reducir todo a 1 ecuación
  ...
  $\begin{align}\frac{dI}{dt} & =  - \alpha I + \mu I (I-1)\\

                              &=   \mu I \left( 1 - \frac{\alpha}{\mu} -  I \right)
  \end{align}$


"

# ╔═╡ 6a99909b-c940-4ad7-9954-c2524b559da6
...
# ╔═╡ 6679f5eb-b7b5-4332-ba82-7e46d4abf28c
begin
μ=1; α =.5 
Xd = sim_sis(.001,100,0.01,[μ,α])
end

# ╔═╡ 24fa6f64-9ce2-4419-9b22-f4cf54278706
plot(Xd); hline!([1-α/μ], c=:grey, ls=:dash)

# ╔═╡ fd26fc24-c156-46b3-8844-4178cdb0a3ef
md"## Ejercicio

* Hacer gráfico de bifurcación

## Ejercicio opcional

* Hacer el diagrama de bifurcación agregando vacunación y comparar 
"

# ╔═╡ bf9db267-3977-4ceb-8c9d-68097a2b1e37
md"## Simulación estocástica

* Hay que tener en cuenta que tenemos $S + I =N > 1$
"

# ╔═╡ ec51a9e7-292c-4abb-aa34-92944d8a64c9
...
# ╔═╡ ce94f30b-5ab4-4321-9e40-4dad449f8bbe
	begin
	par = [0.1,1, 100];
	X = sim_sis_sto(50,100,par)
	end

# ╔═╡ d192086d-5668-4828-9fe0-9535e2a02041
plot(X[1],X[2]);plot!(X[1],X[3])

# ╔═╡ 3241ccd8-4177-4880-a2f5-e79bc3ea42cc
md"
* Recordar que el valor de equilibrio $I^* = N 	- \alpha / \mu$ 
"

# ╔═╡ 855e04cf-937e-4acd-b37d-1018d47c52ec
...
# ╔═╡ 4032e8f4-6ec0-43ec-bd38-f57869ca943d
begin
	parz = [.01,.5,100]
...
# ╔═╡ c63457e3-71fb-4dbd-bdd3-bf8bb1727817
